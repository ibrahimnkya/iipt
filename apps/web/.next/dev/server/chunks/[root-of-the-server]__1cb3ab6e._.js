...
"[project]/apps/web/src/app/api/test/fix-orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const paidInvoices = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].invoice.findMany({
            where: {
                status: "PAID"
            },
            include: {
        ...
        for (const invoice of paidInvoices){
            if (invoice.order && (invoice.order.status !== "PAID" || invoice.order.validationStatus !== "VALID")) {
                updates.push(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].order.update({
                    where: {
                        id: invoice.orderId
                    },
                    data: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].$transaction(updates);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1cb3ab6e._.js.map