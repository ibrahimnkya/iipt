...
async function POST(req) {
    try {
        ...
        const { email, password, fullName, phone, postalAddress, physicalAddress, brelaNumber, tinNumber, natureOfBusiness, signature } = body;
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].user.findUnique({
            where: {
                email
            }
        });
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].user.create({
            data: {
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__122b482e._.js.map