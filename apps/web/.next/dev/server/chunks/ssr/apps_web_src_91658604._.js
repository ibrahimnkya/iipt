...
function ViewOrderPage() {
    ...
    const handleDownloadPDF = ()=>{
        if (order) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pdfGenerator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["downloadOrderAsPDF"])(order.id, `ORD-${order.id.slice(0, 8).toUpperCase()}`);
        }
    };
...
//# sourceMappingURL=apps_web_src_91658604._.js.map