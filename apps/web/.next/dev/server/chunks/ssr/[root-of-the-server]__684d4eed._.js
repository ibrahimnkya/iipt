...
function PaymentModal({ isOpen, onClose, invoice, onSuccess }) {
    ...
    const handleDownloadReceipt = async ()=>{
        if (invoice && successPaymentData) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pdfGenerator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PdfGenerator"].generateReceipt(fullInvoice, successPaymentData);
        }
    };
    const handleClose = ()=>{
        setStep("SELECT");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__684d4eed._.js.map