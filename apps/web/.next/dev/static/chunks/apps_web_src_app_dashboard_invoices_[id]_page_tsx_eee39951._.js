...
function InvoiceDetailPage() {
    ...
    const handleDownloadPDF = ()=>{
        if (invoice) {
            downloadInvoiceAsPDF(invoice.id, `INV-${invoice.id.slice(0, 8).toUpperCase()}`);
        }
    };
...
//# sourceMappingURL=apps_web_src_app_dashboard_invoices_%5Bid%5D_page_tsx_eee39951._.js.map